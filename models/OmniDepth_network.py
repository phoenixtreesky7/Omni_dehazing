...
from util.util_omni import xavier_init
...
class RectNet(nn.Module):
    ...
    def __init__(self):
        ...
        # Network definition
        self.input0_0 = ConELUBlock(3, 8, (3, 9), padding=(1, 4))
        self.input0_1 = ConELUBlock(3, 8, (5, 11), padding=(2, 5))
        self.input0_2 = ConELUBlock(3, 8, (5, 7), padding=(2, 3))
        self.input0_3 = ConELUBlock(3, 8, 7, padding=3)

        self.input1_0 = ConELUBlock(32, 16, (3, 9), padding=(1, 4))
        self.input1_1 = ConELUBlock(32, 16, (3, 7), padding=(1, 3))
        self.input1_2 = ConELUBlock(32, 16, (3, 5), padding=(1, 2))
        self.input1_3 = ConELUBlock(32, 16, 5, padding=2)

        self.encoder0_0 = ConELUBlock(64, 128, 3, stride=2, padding=1)
        self.encoder0_1 = ConELUBlock(128, 128, 3, padding=1)
        self.encoder0_2 = ConELUBlock(128, 128, 3, padding=1)

        self.encoder1_0 = ConELUBlock(128, 256, 3, stride=2, padding=1)
        self.encoder1_1 = ConELUBlock(256, 256, 3, padding=2, dilation=2)
        self.encoder1_2 = ConELUBlock(256, 256, 3, padding=4, dilation=4)
        self.encoder1_3 = ConELUBlock(512, 256, 1)

        self.encoder2_0 = ConELUBlock(256, 256, 3, padding=8, dilation=8)
        self.encoder2_1 = ConELUBlock(256, 512, 3, padding=16, dilation=16)
        self.encoder2_2 = ConELUBlock(768, 512, 1)

        self.decoder0_0 = ConTransposeELUBlock(
            512, 256, 4, stride=2, padding=1)
        self.decoder0_1 = ConELUBlock(256, 256, 5, padding=2)

        prediction0 = [nn.Conv2d(256, 1, 3, padding=1), nn.Tanh()]
        self.prediction0 = nn.Sequential(*prediction0)

        self.decoder1_0 = ConTransposeELUBlock(
            256, 128, 4, stride=2, padding=1)
        self.decoder1_1 = ConELUBlock(128, 128, 5, padding=2)
        self.decoder1_2 = ConELUBlock(129, 64, 1)

        #prediction1 = [nn.Conv2d(64, 1, 3, padding=1), nn.Tanh()]
        #self.prediction1 = nn.Sequential(*prediction1)
...
class UResNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.decoder1_0 = ConTransposeELUBlock(
            ...
            stride=2,
            padding=1)
        self.decoder1_1 = ConELUBlock(
            in_channels=256,
            out_channels=256,
            kernel_size=5,
            stride=1,
            padding=2)
        self.decoder2_0 = ConTransposeELUBlock(
            in_channels=256,
            out_channels=128,
            kernel_size=4,
            stride=2,
            padding=1)
        self.decoder2_1 = ConELUBlock(
            in_channels=128 + 1,
            out_channels=128,
            kernel_size=5,
            stride=1,
            padding=2)
        self.decoder3_0 = ConTransposeELUBlock(
            in_channels=128,
            out_channels=64,
            kernel_size=4,
            stride=2,
            padding=1)
        self.decoder3_1 = ConELUBlock(
            in_channels=64 + 1,
            out_channels=64,
            kernel_size=5,
            stride=1,
...
class ConELUBlock(nn.Module):
    ...
    def __init__(self,
                 ...
                 padding=0,
                 dilation=1):
        super(ConELUBlock, self).__init__()
...
# -----------------------------------------------------------------------------
class ConTransposeELUBlock(nn.Module):
    ...
    def __init__(self,
                 ...
                 padding=0,
                 dilation=1):
        super(ConTransposeELUBlock, self).__init__()
...
class SkipBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = ConELUBlock(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=3,
            stride=2,
            padding=1)
        self.conv2 = ConELUBlock(
            in_channels=out_channels,
            out_channels=out_channels,
            kernel_size=3,
            stride=1,
            padding=1)
        self.conv3 = ConELUBlock(
            in_channels=out_channels,
            out_channels=out_channels,
            kernel_size=3,
            stride=1,
